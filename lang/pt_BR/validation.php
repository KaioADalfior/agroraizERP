...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Chaves não traduzidas aqui usam o idioma reserva (fallback_locale).
    |
    */
    ...
    'unique' => 'Já existe um registro com este valor em :attribute.',
    'uploaded' => 'Falha ao enviar o arquivo em :attribute.',
